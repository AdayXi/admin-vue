  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey'
      ...
      <el-table-column width="200"
                       align="center"
                       label="病案号"> <template scope="scope">
          <span>{{scope.row.mr}}</span>
        </template> </el-table-column>
      <el-table-column width="200"
                       align="center"
                       label="识别号"> <template scope="scope">
          <span>{{scope.row.ident}}</span>
        </template> </el-table-column>
      <el-table-column width="180"
                       align="center"
                       label="入院次数"> <template scope="scope">
          <span>{{scope.row.beHosp}}</span>
        </template> </el-table-column>
      <el-table-column width="180"
                       align="center"
                       label="健康卡号"> <template scope="scope">
          <span>{{scope.row.healthCard}}</span>
        </template> </el-table-column>
      <el-table-column width="180"
                       align="center"
    ...
    <el-dialog title="列表详情"
      ...
      <el-form :model="form"
        ...
        <el-form-item label="接诊日期"
                      prop="telPhone">
          <el-input v-model="form.treatDate"
                    placeholder=""></el-input>
        </el-form-item>
        ...
        <el-form-item label="确诊日期"
                      prop="telPhone">
          <el-input v-model="form.diagDate"
                    placeholder=""></el-input>
        </el-form-item>
...
import {
  ...
  delObj,
  putObj
} from 'api/new/patient/sickdata/index';
