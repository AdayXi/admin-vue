  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter"
                ...
                class="filter-item"
                placeholder="请输入来源渠道"
                v-model="nameid.chanName"> </el-input>
    ...
    <el-table :key='tableKey'
      ...
      <el-table-column width="200"
                       align="center"
                       label="来源渠道"> <template scope="scope">
          <span>{{scope.row.chanName}}</span>
        </template> </el-table-column>
      <el-table-column width="180"
                       align="center"
                       label="业务类型"> <template scope="scope">
          <span>{{scope.row.businessType}}</span>
        </template> </el-table-column>
      <el-table-column width="180"
                       align="center"
                       label="备注"> <template scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form :model="form"
        ...
        <el-form-item label="来源渠道"
                      prop="chanName">
          <el-input v-model="form.chanName"
                    placeholder="请输入来源渠道"></el-input>
        </el-form-item>
